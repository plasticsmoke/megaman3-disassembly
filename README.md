...
- **Stage progression system**: `stage_select_progression` routine in bank03 annotated — $61 boss-defeated bitmask accumulation, Robot Master → Doc Robot tier transition ($61=$FF → $60=$09), Doc Robot → Wily transition ($60=$12). Stage select cursor and lookup table in bank18.
