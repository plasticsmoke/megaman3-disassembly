...
code_0C81D7:
  LDA #$08                                  ; $0C81D7 |
  STA $97                                   ; $0C81D9 |
  JSR process_frame_yield                           ; $0C81DB |
...
code_0C8236:
  ...
  JSR task_yield                           ; $0C8276 |
  LDX #$01                                  ; $0C8279 |
  JSR code_0C85F3                           ; $0C827B |
  JSR task_yield                           ; $0C827E |
  LDX #$10                                  ; $0C8281 |
  JSR code_0C85F3                           ; $0C8283 |
  JSR task_yield                           ; $0C8286 |
  LDX #$11                                  ; $0C8289 |
  JSR code_0C85F3                           ; $0C828B |
  JSR task_yield                           ; $0C828E |
  LDX #$06                                  ; $0C8291 |
...
code_0C8362:
  ...
  STA $97                                   ; $0C8365 |
code_0C8367:
  JSR process_frame_yield                           ; $0C8367 |
  JMP code_0C82B6                           ; $0C836A |

code_0C836D:
  LDA $0560                                 ; $0C836D |
  STA $97                                   ; $0C8370 |
  JSR process_frame_yield                           ; $0C8372 |
  LDA $05A0                                 ; $0C8375 |
  BEQ code_0C836D                           ; $0C8378 |
  LDA #$00                                  ; $0C837A |
  STA $05E0                                 ; $0C837C |
  LDX #$78                                  ; $0C837F |
  JSR task_yield_x                           ; $0C8381 |
  LDA #$10                                  ; $0C8384 |
  STA $F8                                   ; $0C8386 |
  LDA #$88                                  ; $0C8388 |
  STA $5E                                   ; $0C838A |
code_0C838C:
  ...
  JSR process_frame_yield_full                           ; $0C8394 |
  LDA #$00                                  ; $0C8397 |
  STA $05E0                                 ; $0C8399 |
...
code_0C83C5:
  ...
  LDA #$00                                  ; $0C83D0 |
  STA $05E0                                 ; $0C83D2 |
  JSR process_frame_yield_full                           ; $0C83D5 |
...
code_0C8453:
  ...
  INC $0502                                 ; $0C845D |
code_0C8460:
  JSR process_frame_yield_full                           ; $0C8460 |
...
code_0C850F:
  ...
  STA $0310                                 ; $0C8541 |
code_0C8544:
  JSR process_frame_yield_full                           ; $0C8544 |
  LDX $0500                                 ; $0C8547 |
  LDA $86C8,x                               ; $0C854A |
  CMP $05B0                                 ; $0C854D |
...
code_0C8566:
  ...
  LDX #$04                                  ; $0C856F |
  JSR task_yield_x                           ; $0C8571 |
  JMP code_0C8566                           ; $0C8574 |

code_0C8577:
  LDX #$B4                                  ; $0C8577 |
  JSR task_yield_x                           ; $0C8579 |
  INC $0500                                 ; $0C857C |
  LDA $0500                                 ; $0C857F |
  CMP #$08                                  ; $0C8582 |
...
code_0C85BD:
  ...
  STA $10                                   ; $0C85DE |
  LDY $29                                   ; $0C85E0 |
  JSR queue_metatile_update                           ; $0C85E2 |
code_0C85E5:
  PLA                                       ; $0C85E5 |
  STA $28                                   ; $0C85E6 |
  DEC $28                                   ; $0C85E8 |
